  ...
  public class Task
  {
    ...
    public static List<Task> GetAll()
    {
      ...
      while(rdr.Read())
      {
        ...
        bool taskFinished = rdr.GetBoolean(2);
        Task newTask = new Task(taskDescription, taskId, taskFinished);
    ...
    public void Save()
    {
      ...
      SqlCommand cmd = new SqlCommand("INSERT INTO tasks (description, finished) OUTPUT INSERTED.id VALUES (@TaskDescription, @TaskFinished)", conn);
      ...
      SqlParameter finishedParam = new SqlParameter();
      finishedParam.ParameterName = "@TaskFinished";
      finishedParam.Value = this.GetFinished();

      cmd.Parameters.Add(descriptionParam);
      cmd.Parameters.Add(finishedParam);

      SqlDataReader rdr = cmd.ExecuteReader();

      while(rdr.Read())
      {
        this._id = rdr.GetInt32(0);  //id is being generated by the database
      }
      if (rdr != null)
      {
        rdr.Close();
    ...
    public static Task Find(int id)
    {
      ...
      bool foundTaskFinished = false;

      while(rdr.Read())
      {
        foundTaskId = rdr.GetInt32(0);
        foundTaskDescription = rdr.GetString(1);
        foundTaskFinished = rdr.GetBoolean(2);
      }
      Task foundTask = new Task(foundTaskDescription, foundTaskId, foundTaskFinished);
